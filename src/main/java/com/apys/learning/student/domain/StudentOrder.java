...
public class StudentOrder {
    ...
    @AssociationOverrides({
            ...
            @AssociationOverride(name = "pasportOffice", joinColumns = @JoinColumn(name = "h_passport_offece_id")),
    ...
    @AssociationOverrides({
            ...
            @AssociationOverride(name = "pasportOffice", joinColumns = @JoinColumn(name = "w_passport_offece_id")),
